...
<div id="">
  <div class="pagetitle">
    <h1>Event Approval [President]</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="">Home</a></li>
          <li class="breadcrumb-item active">List of Event Request for Approval</li>
          
          <li class="ml-auto btn"><a href="#" id="breadcrumb_event_approved_pres"><i class="bi bi-vinyl"></i> Approved</a></li>
          <li class="btn"><a href="#" id="breadcrumb_event_rejected_pres"><i class="bi bi-vinyl"></i> Rejected</a></li>
        </ol>
      </nav>
  </div><!-- End Page Title -->
...
<div id="div_president">
    <!--table-striped table-dark   style="width:100%"-->
    <table id="table_event_approval_president_list" class="table table-striped table-sm table-hover" style="width:100%">
...
<script type="text/javascript">
  var base_url = "<?= base_url() ?>";
    ...
    //START DISPLAY DATA ON DATA TABLE
        ...
        var table = $('#table_event_approval_president_list').dataTable({
            ...
            "ajax": { 
                "url" : "<?php echo base_url('Employee/table_event_approval_president_list'); ?>",
