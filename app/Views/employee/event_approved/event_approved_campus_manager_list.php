    ...
    <table id="table_event_approved_campus_manager_list" class="table table-striped table-sm table-hover" style="width:100%">
...
<script type="text/javascript">
  var base_url = "<?= base_url() ?>";
    ...
    //START DISPLAY DATA ON DATA TABLE
        ...
        var table = $('#table_event_approved_campus_manager_list').dataTable({
