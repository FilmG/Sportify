<div id="div_course_coordinator">
    ...
    <table id="table_event_approved_course_coordinator_list" class="table table-striped table-sm table-hover" style="width:100%">
        <caption>List of Approved Event</caption>
...
<script type="text/javascript">
  var base_url = "<?= base_url() ?>";
    ...
    //START DISPLAY DATA ON DATA TABLE
        ...
        var approved_value = 2;

        var table = $('#table_event_approved_course_coordinator_list').dataTable({
