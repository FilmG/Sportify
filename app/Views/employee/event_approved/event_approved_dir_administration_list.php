    ...
    <table id="table_event_approved_dir_administration_list" class="table table-striped table-sm table-hover" style="width:100%">
...
<script type="text/javascript">
  var base_url = "<?= base_url() ?>";
    ...
    //START DISPLAY DATA ON DATA TABLE
        ...
        var table = $('#table_event_approved_dir_administration_list').dataTable({
