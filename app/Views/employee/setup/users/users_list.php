...
<table id="table_setup_users_list" class="table table-striped table-sm table-hover" style="width:100%">
    <caption></caption>
...
<script type="text/javascript">
  var base_url = "<?= base_url() ?>";
    ...
    //START DISPLAY DATA ON DATA TABLE
        ...
        var table = $('#table_setup_users_list').dataTable({
            ...
            "ajax": { 
                "url" : "<?php echo base_url('Users/table_setup_users_list'); ?>",
