    ...
    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <tr>
                                            <td colspan="3" style="text-align:center"><?= $value['match_time_text']; ?> @ <?= $value['match_venue']; ?></td>
                                        </tr>
                                    </table>
	    ...
	    <!--Column RIGHT -start -->
         <div class="col">
                ...
                <div class="alert alert-secondary">Basketball Team Standing</div>
                <table id="table_basketball_standing" class="table table-striped table-sm table-hover" style="width:100%">
                    <thead>
...
<script type="text/javascript">
    ...
    load_basketball_standing(); //load basketball standing
    ...
    function load_basketball_standing() {
        var recid_sports_activity = $("#recid_sports_activity").val();
        //alert(recid_sports_activity);
        //WORKING AJAX FUNCTION WITH DATA {}
        var base_path = base_url + "/Games/view_basketball_standing"; 
        $.ajax({
            type: "POST",
            url: base_path,
                ...
                success: function(data) {
                    ...
                    if(data.length > 0) {
                        for(var count=0;count < data.length; count++) { 
                            ...
                            $('#table_basketball_standing').append(
